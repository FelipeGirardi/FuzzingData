...
for i, _ in enumerate(no_covered_edges_indexes):
    edges_covered_copy = np.delete(edges_covered, i)
    edges_total_copy = np.delete(edges_total, i)
    labels_copy = np.delete(labels, i)
